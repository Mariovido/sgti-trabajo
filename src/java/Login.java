...
public class Login extends HttpServlet {
    public void doGet(HttpServletRequest req, HttpServletResponse res) {
        try{
            ...
            out.println("<li class='main-header__item'><a class='active' href=''>Iniciar sesi�n</a></li>");
            out.println("</ul>");
            out.println("</nav>");
            out.println("</header>");
            ...
            out.println("<div class='form__group'>");
            out.println("<input name='PASS' type='password' placeholder='Contrase�a' class='form__input' />");
            out.println("</div>");

            out.println("<button class='btn' type='submit'>Iniciar sesi�n</button>");
            out.println("</form>");
            out.println("</div>");
            out.println("</main>");
            out.println("</body>");
